...
| ✅ | `brain-prd` | `/prd [任务简称]` · "立PRD" · "起草PRD" · "写交付标准" | 立 PRD——功能/需求验收基线，不是审批单（v1.5.3 · 2026-08-18 十~十三轮合同 · canonical=`brain/.skills/brain-prd/SKILL.md` · portable/.skill 包/Cowork/Claude-3p 为派生消费端） | `archived/brain/brain-prd.skill` |
