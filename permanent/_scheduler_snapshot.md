...
> 由 `brain/.tools/scheduler_snapshot.py` 生成于 2026-08-30T05:14:50-07:00（triggered_by=manual），**只读**。

> **本文件纳入 git；跑完 `git diff` 即知自上次快照以来什么变了** —— 无论改动来自 Doctor、别的会话还是 CC 自己。

> 镜像步：镜像已同步：26 文件（更新 10 · 移除 0） · Artifacts：9 个（拷 7 · 清单全量）
...
| `bak-diaoyan-20260827` | 2026-08-26 01:40 | 21 | `df604c0b7e59` | 渊图 bak_20260820_diaoyan 保护期到期提醒（08-27 摘 protect 并归档） |
...
| `event-attribution-watch` | 2026-08-29 05:02 | 174 | `e09f88b815f4` | EAL v3 数据链日更班：行情更新→sealed 快照→manifest-gated exact registry→冻结 XNYS 日历→DAILY_SHADOW→fresh candidate→事后归因 loop→a… |
...
| `shenghong-h1-verify` | 2026-08-25 23:19 | 32 | `d16a08ba3630` | 胜宏科技2026半年报M9/M10认证表述核验（08-28披露后一次性预核班） |
