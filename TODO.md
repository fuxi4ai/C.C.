...
- [ ] **渊图 · 兴森「广州兴森 2025 收入 2689.99 万/净亏 5.33 亿」两数待核（2026-08-12 由 /todo 漏挂对账补挂 · 源：`logs/2026-08-12-ABF清洗与canonical入库.md`）**：VV 标 P0、CC 标 P0-待验，下次翻年报原文顺手核。

- [ ] **渊图 · 373 个历史幽灵 file 专项审计（2026-08-12 由 /todo 漏挂对账补挂 · 源：同上）**：07-18 遗留 + 本次 21 节点 unresolvable 有交集，与畸形节点还原专场合并看。
