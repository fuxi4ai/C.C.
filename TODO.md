...
- [ ] **渊图 · 档案计数漂移对账（2026-08-20 挂 · 源：调研情报局入库场实测）**：canonical 实测 4960/5539 vs 档案 08-19 手术记 4964/5542 差 −4/−3——NOTE-20260719-001 族「档案计数未随修复回写」镜像（同族 −1/−12 已于 08-19 对账为 08-17 VV 盲审修复）。本处待 Doctor 裁：深查（git log 对 08-19→08-20 变更）或直接按实测回写档案。
