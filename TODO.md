...
- [ ] **白泽大宗 · benefit_relations 银泰黄金→山金国际名称规范化（2026-08-06 挂 · ⇒ ✅ 已做 2026-08-13）**：id=918 name「银泰黄金」→「山金国际」+ ts_code 补 000975.SZ；龙鱼侧 grep 零残留，白泽 archive 历史脚本静态配置留档不动。
...
- [ ] **金融 · A股首样本记账（2026-07-30 挂 · Doctor 2026-08-03 定补记另开专场 · ②③④ 已收口 2026-08-13 目标模式收窄）**
...
- [ ] **金融 · macro_prediction.db 择一为源（2026-08-08 挂 · ⇒ 摸清 2026-08-13）**：v3（macro_predictions_v3）是白泽观星引擎 engine_cn.py 写的新版口径（L662 建表），v1 是旧表；消费方=白泽观星。**待裁**：v3 为源 + v1 标 deprecated。

- [ ] **渊图 · kg_ingest 机制修复（2026-08-09 挂 · ①②④⑤ 已收口 2026-08-13）**：③ 机制修复——kg_ingest 价格钩子加幂等查重（同事实键不落第二条）＋ CLAUDE.md 入库流程加防重跑保险丝（batch 前查拟处理文件 kg_processed 全 true 即停）。源：渊图_GOTCHAS NOTE-20260808-001。
...
- [ ] **白泽大宗 · 中际旭创 1.6T 双值核验（2026-08-10 挂 · ⇒ ✅ 标口径双留 2026-08-13）**：benefit_relations 0.4 保留 + raw_json 加口径注记（0.4 vs history latest 0.15，疑分母口径不同，原文不可得待核）。
  **⇒ 2026-08-11 目标模式现核：定为大活 · 转专场（退出「清到0」范围，另批专场）**
