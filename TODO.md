...
- [ ] **dev/19 班迁移收尾（2026-08-09 挂 · 收窄 2026-08-14）**：① 已清 · ⑤ V.V. 盲审 **08-14 闭环** · ⑦ Brain/brain 记档（D16）· ⑧ Settings 镜像 L20 撤除——沙箱侧已落。**剩**：②③ 终封 diff 复跑 + longyu 步骤 2/3 核实（命令已贴 · Doctor 终端）· ④ 龙鱼看板幽灵归档（命令已贴）· ⑥ workspace 7-05 拷贝归档（命令已贴）——跑完整条闭环，待 Doctor 勾。
