...
- [ ] **金融 · 时效性记账与核数三件（2026-07-30 从当日三场日志补挂 · 过期即作废或成本剧增）**
  ...
  　**⏸ 剩余待办**：**07-30 的 2Y/10Y**——H.15 截至 07-31 04:00 ET 只发到 07-29，07-30 两值今日 **16:15 ET** 后可取（命令：`curl -s "https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGS2,DGS10&cosd=2026-07-24" | tail -8`）。拿到前「24pp 回落里 07-29 占多少 / 07-30 占多少」**仍未拆开**，⑤ 与 P-05 退款腿归属、④⑤ 权重带**继续冻结**。
