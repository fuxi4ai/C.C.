...
- [ ] **dev/19 班迁移收尾（2026-08-09 挂 · 收窄 2026-08-14）**：① 已清 · ⑤ V.V. 盲审 **08-14 闭环**（新包→独立审查→对账回执→长飞归因修正，回执落握手层）。**剩**：② 字节级终封 diff 复跑 · ③ longyu 步骤 2/3 核实 · ④ 龙鱼看板幽灵归档 · ⑥ workspace 7-05 旧副本处置 · ⑦ Brain/brain 大小写归一（记档不动）· ⑧ Settings 镜像 L20 撤除——小尾随 Q6 终端包。
