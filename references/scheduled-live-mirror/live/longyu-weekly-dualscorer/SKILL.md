...
## 历史特别任务（已退役 · 2026-08-24 Doctor 裁）

- 2026-08-15 轮曾额外补跑 3 只 CPO 纯正股（天孚 `300394.SZ`/仕佳 `688313.SH`/光库 `300620.SZ`，CPO 视角锚点见 git 历史）。**已于 2026-08-24 退役：不再特跑。** CPO 三只如需周更，请 Doctor 裁入常更清单。
- 2026-08-24：长鑫 `688825.SH`/南亚 `688519.SH` 持仓补腿已由 CC 当日现场闭环（ds+claude 双腿落库 records）——本班无需注记补跑；两只如需周更同上（入常更清单裁定）。
...
- 常更清单唯一真源=`常更标的.json`（Doctor 用 常更标的审核.html 维护）；只跑其中 A股。（历史特跑已退役 2026-08-24，见上。）
