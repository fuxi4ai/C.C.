...
## 本轮特别任务（2026-08-15 · CPO 补跑 · Doctor 2026-08-12 批）

本轮除常更清单外，**额外补跑 3 只 CPO 纯正股**（不在常更清单）：
- 天孚通信 `300394.SZ`
- 仕佳光子 `688313.SH`
- 光库科技 `300620.SZ`

（源杰科技 `688498`、炬光科技 `688167`、中际旭创 `300308`、新易盛 `300502` 已在常更清单，照常跑；罗博特科已剔除，不跑。）

第 1 步取常更清单后，把上述 3 只并入（去重）。deepseek 腿照常 `--write --save-pack`；claude 腿按 **CPO 视角**判分，锚点：
- Lumentum Q4 FY26（8/11 美东发布）：营收 $10.06 亿 +109%、Q1 FY27 指引 $12.25–12.75 亿；1.6T 已出货、200G EML 两倍单价、**CPO 外置光源 UHP 芯片爬坡确认 2027H2**、OCS 积压 >$4 亿、铜转光 pivot。
- 纯正性甄别：真龙头（旭创/新易盛/天孚/源杰/仕佳/光库/炬光）vs 炒作（华西/永鼎/通鼎/兆龙/金信诺——铜缆是被替代侧）。
- 源杰 2025 年报实证：数通 3.93 亿 +719%、GM 72.2%、第一大客户 53.35%（共识旭创 P2）；**「价先于量」**——紧缺期客户集中度是价的风险（续约季压 GM），量风险待紧缺结束。
- CW 供需平衡锚 LightCounting（2026-05 口径：价格稳定/年底或环比走平一两季；平衡分功率档位，300mW+/CPO 反将转入新紧缺）。
- FCC 传导：链短时点错开，基准情景 2026-27 几乎无传导，传导打 2028+ 增量期权。

天孚/仕佳已入 `细分环节.json` 光通信组（map），本轮跑完 step 6 重建看板时随 records 出现在光通信组。
...
- 常更清单唯一真源=`常更标的.json`（Doctor 用 常更标的审核.html 维护）；只跑其中 A股。（本轮特别任务另有 3 只 CPO 纯正股额外补跑，见上。）
