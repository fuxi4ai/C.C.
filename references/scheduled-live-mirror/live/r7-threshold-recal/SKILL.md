...
4. 重校准（仅当闸门通过）：跑 python3 /Users/lunarabbit/Documents/Claude/Projects/风险日报/mech-watch/calibrate_usdjpy.py（只读 /Users/lunarabbit/Documents/Database/宏观研究体系/EAL/attribution.db，C:USDJPY 15m），对比新分位与现阈值：🔴1.5% 的年化频次是否仍合理、🟠0.7% 月均触发是否仍约 2 天、1h 辅证阈同理。
