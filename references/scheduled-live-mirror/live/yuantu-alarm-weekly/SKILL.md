...
4. 给 Doctor 一份简报（敬语、简洁、去冗余）：只讲有异动或升级的条目 + 一句话证据 + 来源链接（markdown）。若本周全部无异动，就一行「本周 6 个警报时点均无异动，状态维持 watching」。杀伤指数最高的是「2027 收敛」(Oracle+CoreWeave+OpenAI 三雷同年)，最快验证的是「折旧年限多米诺」——这两条优先重点看。
